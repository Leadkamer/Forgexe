...
(function(){
  ...
  var html = ''
    ...
    + '      <p class="scan-done-desc">Je ontvangt jouw rapport binnen 48 uur. We nemen zo snel mogelijk contact op om door te nemen wat we vinden.</p>'
    + '      <div class="scan-done-checks">'
    + '        <span><strong>&#10003;</strong> Rapport binnen 48 uur</span>'
